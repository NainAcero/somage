    ...
    class ponentesController extends Controller{
        ...
        public function index(){
            ...
            $data = [
                ...
                [
                    "nombre" => "JESÚS AMADEO OLIVERA CÁCERES",
                    "comision" => "Decano de la Facultad de Ciencias Jurídicas y Empresariales de la Universidad Nacional Jorge Basadre Grohmann.",
                    "foto" => "ponente02.jpg",
                    "fotoPais" => "peru.png",
                    "nacionalidad" => "Peruana"
                ],
                [
                    "nombre" => "ALBERTO FRANCO VILDOSO",
                    "comision" => "",
                    "foto" => "ponente03.png",
                    "fotoPais" => "peru.png",
                    "nacionalidad" => "Peruana"
                ...
                [
                    "nombre" => "SEGUNDO MANUEL ALVARADO CONTRERAS",
                    "comision" => "",
                    "foto" => "ponente04.png",
                    "fotoPais" => "peru.png",
                    "nacionalidad" => "Peruana"
